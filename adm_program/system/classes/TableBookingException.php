 ...
 */
class TableBookingException extends TableAccess
{
    /**
     ...
     */
    public function __construct(Database $database, $bexId = 0)
    {
        parent::__construct($database, 'mws__bookexceptions', 'bex', $bexId);
    }
