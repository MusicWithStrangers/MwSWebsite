 ...
 * ```
 */
class TableMusicianRegister extends TableAccess
{
    /**
     ...
     */
    public function __construct(Database $database, $smrId = 0)
    {
        // read also data of assigned category
        //$this->connectAdditionalTable(TBL_CATEGORIES, 'cat_id', 'dat_cat_id');

        parent::__construct($database, 'mws__song_musicianregistration', 'smr', $smrId);
    }
    ...
    {
        $smrId     = (int) $this->getValue('smr_id');
    ...
    public function isEditable()
    {
        ...
        if ($gCurrentUser->getValue('usr_id' === $this->getValue('smr_usr_id')))
        {
