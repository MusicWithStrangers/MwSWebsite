 ...
 */
class TableVenue extends TableAccess
{
    /**
     ...
     */
    public function __construct(Database $database, $venId = 0)
    {
        parent::__construct($database, 'mws__venues', 'ven', $venId);
    }
    ...
    public function delete()
    {
        ...
        $sql = 'DELETE FROM mws__bookings
                      WHERE boo_ven_id = ? -- $this->getValue(\'ven_id\')';
        $this->db->queryPrepared($sql, array($this->getValue('ven_id')));
