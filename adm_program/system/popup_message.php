...
switch ($getType)
{
    ...
    case 'pro_former':
        ...
        break;
    case 'snr':
        $url  = safeUrl(ADMIDIO_URL . FOLDER_MODULES . '/songs/songs_function.php', array('mode' => 9, 'snr_id' => $getDatabaseId));
        $text = 'ROL_LINK_SONG_DEL';
        $callbackFunction = 'callbackFormerSongs';
        break;
    case 'rol':
